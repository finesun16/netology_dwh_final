...
CREATE TABLE fact.flights (
	...
	actual_departure timestamp NOT NULL, -- Дата и время вылета (факт) (bookings.flights.actual_departure)
	actual_arrival timestamp NOT NULL, -- Дата и время прилета (факт) (bookings.flights.actual_arrival)
